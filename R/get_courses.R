...
get_courses <- function() {
  ...
  tibbles[[3]] <- get_cdhu_courses()
  tibbles[[4]] <- get_coderefinery_courses()
  tibbles[[5]] <- get_csc_courses()
  tibbles[[6]] <- get_enccs_courses()
  tibbles[[7]] <- get_hpc2n_courses()
  tibbles[[8]] <- get_infraviz_courses()
  tibbles[[9]] <- get_lunarc_courses()
  tibbles[[10]] <- get_naiss_courses()
  tibbles[[11]] <- get_nsc_courses()
  tibbles[[12]] <- get_pdc_courses()
  tibbles[[13]] <- get_sll_courses()
  tibbles[[14]] <- get_uppmax_courses()
