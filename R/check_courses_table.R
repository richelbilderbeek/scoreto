...
check_courses_table <- function(t) { # nolint indeed a long function name
  ...
  if (any(is.na(t$course_url))) {
    stop(
      ...
      "Course names: ",
      paste(t$course_name[is.na(t$course_url)], collapse = ", ")
    )
  }
  if (any(is.na(t$date_from))) {
    stop(
      ...
      "Course names: ",
      paste(t$course_name[is.na(t$date_from)], collapse = ", ")
    )
  }
  ...
  if (any(!scoreto::are_valid_urls(t$course_url))) {
    stop(
      ...
      "Row indices: ",
      paste(which(!scoreto::are_valid_urls(t$course_url)), collapse = " "), "\n",
      "Malformed course URLs: ",
      paste(t$course_url[!scoreto::are_valid_urls(t$course_url)], collapse = ", "), "\n",
      "Course names: ",
      paste(t$course_name[!scoreto::are_valid_urls(t$course_url)], collapse = ", ")
    )
  }
  if (any(!scoreto::are_valid_urls(t$provider_courses_url))) {
    stop(
      ...
      "Row indices: ",
      paste(which(!scoreto::are_valid_urls(t$provider_courses_url)), collapse = " "), "\n",
      "Malformed course URLs: ",
      paste(t$provider_courses_url[!scoreto::are_valid_urls(t$provider_courses_url)], collapse = ", "), "\n", # nolint
      "Course names: ",
      paste(t$course_name[!scoreto::are_valid_urls(t$provider_courses_url)], collapse = ", ")
    )
  }
  if (any(!scoreto::are_correctly_formatted_dates(t$date_from))) {
    stop(
      ...
      "Row indices: ",
      paste(which(!!scoreto::are_correctly_formatted_dates(t$date_from)), collapse = " "), "\n",
      "Malformed from dates: ",
      paste(t$date_from[!scoreto::are_correctly_formatted_dates(t$date_from)], collapse = ", "), "\n", # nolint
      "Course names: ",
      paste(t$course_name[!scoreto::are_correctly_formatted_dates(t$date_from)], collapse = ", ")
    )
  }
  if (any(!scoreto::are_correctly_formatted_dates(t$date_to))) {
    stop(
      ...
      "Row indices: ",
      paste(which(!!scoreto::are_correctly_formatted_dates(t$date_to)), collapse = " "), "\n",
      "Malformed to dates: ",
      paste(t$date_to[!scoreto::are_correctly_formatted_dates(t$date_to)], collapse = ", "), "\n",
      "Course names: ",
      paste(t$course_name[!scoreto::are_correctly_formatted_dates(t$date_to)], collapse = ", ")
    )
  }
  invisible(t)
}
